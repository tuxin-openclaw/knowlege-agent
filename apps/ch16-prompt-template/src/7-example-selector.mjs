...
const examples = [
  ...
  },
  {
    ...
    report_snippet:
      ...
      "- 监控：新增 8 条核心告警和 3 个 SLO 指标，后续会结合值班反馈继续做噪声收敛。",
  },
];
...
const exampleSelector = await LengthBasedExampleSelector.fromExamples(
  ...
  {
    examplePrompt,
    // 这里使用字符长度近似 token 长度，真实项目中可以配合 tokenizer 使用
    maxLength: 700,
...
// 6. 使用一个较长、较复杂的需求，让 selector 自动选择合适的示例
const currentRequirement =
  "我们本周在做「内部 AI 助手」项目，既有稳定性保障（处理线上问题），" +
  "也有新功能上线（接入知识库、日志检索）。希望周报能体现「把坑都填住了」，" +
  "又能展示一部分业务侧能感知到的亮点。";
